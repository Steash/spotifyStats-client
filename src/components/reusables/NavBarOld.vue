...
<template>
                    ...
                    <div id="right" class="flex-nowrap">
                        ...
                        <div v-if="store.getters.isAuthenticated">
                            ...
                            <button @click="toggleMenu"
                                class="material-symbols-outlined align-middle">account_circle</button>
                            <!-- <div v-if="menuOpen" class="w-full block flex-grow lg:flex lg:items-center lg:w-auto bg-white">
    ...
    <!-- Dropdown menu -->
    <div v-if="menuOpen" class="bg-white text-base z-50 list-none divide-y divide-gray-100 rounded shadow my-4"
        id="dropdown">
